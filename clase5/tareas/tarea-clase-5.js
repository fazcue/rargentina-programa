...
const $submitCalcularSalarioMensual = document.querySelector('#calcular-salario-mensual');

$submitCalcularSalarioMensual.onclick = function() {
  let salarioMensual = document.querySelector('#salario-mensual');

  const salarioAnual = Number(document.querySelector('#salario-anual').value);

  const calculoSalarioMensual = salarioAnual / 12;

  salarioMensual.setAttribute('placeholder', calculoSalarioMensual);
